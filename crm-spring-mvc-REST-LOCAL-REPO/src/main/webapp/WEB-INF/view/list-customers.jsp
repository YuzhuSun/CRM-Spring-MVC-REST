...
<body>
	...
	<div id="container">
		...
		<div id="content">
			...
			<form:form action="searchBy" method = "GET">
			...
			<table>
				<c:url var="sortLinkFirstName" value="list">
					<c:param name="sort" value="<%= SortUtils.FirstName.getValue()%>"/>
				</c:url>
				<c:url var="sortLinkLastName" value="list">
					<c:param name="sort" value="<%= SortUtils.LastName.getValue()%>" />
				</c:url>
				<c:url var="sortLinkEmail" value="list">
					<c:param name="sort" value="<%=SortUtils.Email.getValue()%>"/>
				</c:url>
				<tr>
